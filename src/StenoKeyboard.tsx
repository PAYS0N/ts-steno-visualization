	...
	return (
		<div className="steno-keyboard">
			...
			<div className="bottom-keys">
				<div className="left-vowels">
					<StenoKey selected={keysSelected.includes(9)} label="A"/>
					<StenoKey selected={keysSelected.includes(10)} label="O"/>
				</div>
				<div className="right-vowels">
					<StenoKey selected={keysSelected.includes(12)} label="E"/>
					<StenoKey selected={keysSelected.includes(13)} label="U"/>
				</div>
			</div>
		</div>	
	)
